<template>
<footer class="mt-8 p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
    ...
    <ul class="flex flex-wrap items-center mt-3 sm:mt-0">
        ...
        <li>
            <a href="#" class="mr-4 text-sm text-gray-500 hover:underline md:mr-6 dark:text-gray-400">Privacy</a>
        </li>
        <li>
